...
public:
    ...
    void key_callback(const std_msgs::String & msg) {
        ...
        if (mux_controller[key_mux_idx]) {
            ...
            // } else if (msg.data == "r") {
            //     //need to subscribe to pose topic 
            //     //pose_rviz_topic using 2D pose estimate
            //     // publish scan_topic to see new simulated scan
            //     //restart the simulator and position of the car
            } 
            else {
